...
% R matrix
% ================
sigma=[sigmaip;sigmaiq;sigmatp;sigmatq;sigmau;sigmaup;sigmac;sigmaim;sigmaic;sigps];
...
% ======================
Z=[Pi;Qi;pt;qt;u;Vp;cp;im;ic;ps];
...
evalfunc4(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)

% Jacobian Calculation
%========================
jacobianES4(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)
...
Ztrue=[Piog;Qiog;Ptog;Qtog;uog;vog;cog;imog;icog;Sog];
evalfunc4(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)
