...
% R matrix
% ================
sigma=[sigmaip;sigmaiq;sigmatp;sigmatq;sigmau;sigmaup;sigmac;sigmaim;sigmaic];
...
evalfunc(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)

% Jacobian Calculation
%========================
jacobianES(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)
...
Ztrue=[Piog;Qiog;Ptog;Qtog;uog;vog;cog;imog;icog];
evalfunc(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)
