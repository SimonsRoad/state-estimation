function jacobianHES(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,Shunt)
global Jh Jc
...
i1=1;
 for f=1:nI
   ...
   J8c(i1,i)=-V(i)*((gik+Gii)*sin(c(i))+(bik+Bii)*cos(c(i)));
   J8c(i1,k)=V(k)*(gik*sin(c(k))+bik*cos(c(k)));
   J8v(i1,i)=(gik+Gii)*cos(c(i))-(bik+Bii)*sin(c(i));
   J8v(i1,k)=-gik*cos(c(k))+bik*sin(c(k));
   J8c(i1+1,i)=V(i)*((gik+Gii)*cos(c(i))-(bik+Bii)*sin(c(i)));
   J8c(i1+1,k)=V(k)*(-gik*cos(c(k))+bik*sin(c(k)));
   J8v(i1+1,i)=(gik+Gii)*sin(c(i))+(bik+Bii)*cos(c(i));
   J8v(i1+1,k)=-gik*sin(c(k))-bik*cos(c(k));
   i1=i1+2;
 end

 
Jh=[J1c J1v;J2c J2v;J3c J3v;J4c J4v;J5c J5v;J6c J6v;J7c J7v;J8c J8v];
