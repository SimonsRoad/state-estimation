...
% R matrix
% ================
sigma=[sigmaip;sigmaiq;sigmatp;sigmatq;sigmau;sigmaup;sigmac;sigmaim;sigmaic;sigps;sigps];
...
% ======================
Z=[Pi;Qi;pt;qt;u;Vp;cp;im;ic;ps;ps];
...
evalfunc2(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)

% Jacobian Calculation
%========================
jacobianES2(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)
...
delta=inv([H'*inv(R)*H -C';-C zeros(length(cons))])*[H'*inv(R)*(Z-h);cons]; % x 1E4 
...
Ztrue=[Piog;Qiog;Ptog;Qtog;uog;vog;cog;imog;icog;Sog;Sog];
evalfunc2(States,B,Bus,Cp,Cq,Dp,Dq,E,F,K,S,Shunt)
